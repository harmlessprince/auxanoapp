<?php
$isTicketActive = strpos(Route::currentRouteName(), 'tickets.index') === 0 || strpos(Route::currentRouteName(), 'tickets.show') === 0 || strpos(Route::currentRouteName(), 'tickets.edit') === 0;
?>
<?php if (isset($component)) { $__componentOriginal14dbe3674c0bdbfb11874d366bd03cff4359e978 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\SideMenu::class, ['url' => 'tickets.index','title' => 'Tickets','active' => $isTicketActive]); ?>
...
<?php endif; ?>
<?php /**PATH /home/harmlessprince/web projects/laravel/auxanoapp/resources/views/partials/aside/desktop/ticket.blade.php ENDPATH**/ ?>