...
} elseif ($_instance->childHasBeenRendered('9i5Pca8')) {
    $componentId = $_instance->getRenderedChildComponentId('9i5Pca8');
    $componentTag = $_instance->getRenderedChildComponentTagName('9i5Pca8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9i5Pca8');
} else {
    $response = \Livewire\Livewire::mount('category-form-modal');
    $html = $response->html();
    $_instance->logRenderedChild('9i5Pca8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
