...
} elseif ($_instance->childHasBeenRendered('KCNALkB')) {
    $componentId = $_instance->getRenderedChildComponentId('KCNALkB');
    $componentTag = $_instance->getRenderedChildComponentTagName('KCNALkB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KCNALkB');
} else {
    $response = \Livewire\Livewire::mount('category-form-modal');
    $html = $response->html();
    $_instance->logRenderedChild('KCNALkB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
