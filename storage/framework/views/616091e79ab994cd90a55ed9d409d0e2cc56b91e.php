...
} elseif ($_instance->childHasBeenRendered('MybduXN')) {
    $componentId = $_instance->getRenderedChildComponentId('MybduXN');
    $componentTag = $_instance->getRenderedChildComponentTagName('MybduXN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MybduXN');
} else {
    $response = \Livewire\Livewire::mount('company-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('MybduXN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
