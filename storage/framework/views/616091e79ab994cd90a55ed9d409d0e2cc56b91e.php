...
} elseif ($_instance->childHasBeenRendered('JbjgSna')) {
    $componentId = $_instance->getRenderedChildComponentId('JbjgSna');
    $componentTag = $_instance->getRenderedChildComponentTagName('JbjgSna');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('JbjgSna');
} else {
    $response = \Livewire\Livewire::mount('company-form', []);
    $html = $response->html();
    $_instance->logRenderedChild('JbjgSna', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
