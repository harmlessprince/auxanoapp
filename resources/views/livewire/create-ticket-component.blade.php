...
@section('content')
    <div class="flex flex-col w-3/4 mx-auto bg-white rounded-lg shadow-xl dark:bg-gray-800 p-5">
        <form wire:submit.prevent="StoreTicket" method="POST">
            @csrf
            <div class="flex flex-wrap -mx-3 mb-3">
                <div class="w-full px-3 mb-3">
                    ...
                    <x-input id="ticket_name" class="block mt-1 w-full" type="text" name="ticket_name"
                        :value="old('ticket_name')" required autofocus placeholder='' wire:model.defer="ticket_name" />
            ...
            <div class="flex flex-wrap -mx-3 mb-3">
                ...
                <div class="w-1/3 px-3 mb-3">
                    ...
                    <x-select required name='status' wire:model.defer="status">
                ...
                <div class="w-1/3 px-3 mb-3">
                    ...
                    <x-select required name='priority' wire:model.defer="priority">
                ...
                <div class="w-1/3 px-3 mb-3">
                    ...
                    <x-select required name='category' wire:model.defer="category">
            ...
            <div class="flex flex-wrap -mx-3 mb-3">
                ...
                <div class="w-full px-3 mb-3">
                    ...
                    <x-select required name='customer' wire:model.defer="customer">
            ...
            <div class="flex flex-wrap -mx-3 mb-3">
                ...
                <div class="w-full px-3 mb-3">
                    ...
                    <x-select required name='assign_to' wire:model.defer="assign_to">
                        <option value="" class="">---Select---</option>
            ...
            <div class="flex flex-wrap -mx-3 mb-3">
                <div class="w-full px-3 mb-3">
                    ...
                    <textarea name="fault_reported"
                        ...
                        rows="3" placeholder="Windows not booting" wire:model.defer="fault_reported"></textarea>
            ...
            <div class="flex flex-wrap -mx-3 mb-3">
                <div class="w-full px-3 mb-3">
                    ...
                    <textarea name="fault_observed"
                        class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-textarea focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
                        rows="3" placeholder="Broken Screen" wire:model.defer="fault_observed"></textarea>
