        ...
        <form method="POST" action="{{ route('customers.update', ['customer' => $customer]) }}">
            ...
            <div class="flex flex-wrap -mx-3 mb-3">
                ...
                <div class="w-1/2 px-3 mb-3">
                    ...
                    <x-input id="email" class="block mt-1 w-full" type="email" name="email" :value="$customer->email"
                ...
                <div class="w-1/2 px-3 mb-3">
                    ...
                    <x-select required name='type'>
                        ...
                        @foreach ($customerTypes as $item)
                            <option value="{{ $item['value'] }}" class="uppercase"
                                @if ($customer->type == $item['value']) selected @endif>
                                {{ $item['name'] }}</option>
                        @endforeach
                    </x-select>
